    ...
    <scroll-view class="page-scroll" scroll-y>
      ...
      <view class="card fragments-card">
        <view v-for="frag in fragments" :key="frag.time" class="fragment-item">
          ...
          <text class="fragment-icon">{{ frag.icon }}</text>
      ...
      <template v-if="previewText">
        ...
        <view class="preview-card">
          <view class="preview-header">
            <text class="preview-style-emoji">{{ selectedStyle?.emoji }}</text>
...
const styles: StyleOption[] = [
  { emoji: '🌸', name: '文艺治愈', desc: '诗意温暖', sample: '三月的风裹着食堂的饭香，酸菜鱼的鲜辣在舌尖跳跃。这是属于南开的日子——图书馆的灯光温柔，操场上的晚风清凉。红黑树的递归调用失败了很多次，但那些在纸上画满节点和边的夜晚，终究会在某一天开花结果。今天的夕阳像一封没寄出的信，收件人是未来的自己。' },
  { emoji: '😂', name: '搞笑吐槽', desc: '毒舌欢乐', sample: '今日份破防记录：红黑树。我真的栓Q了，这个世界上为什么会有一种数据结构叫"红黑树"啊？？？它是红色的吗？它是一棵树吗？它跟黑色有什么关系？？？我看它跟我的脑子有关系——都是空白。还有那个食堂的酸菜鱼，三食堂阿姨手一抖，半条鱼没了，就给我留了个鱼头，我谢谢您嘞🙏' },
  { emoji: '⚔️', name: '武侠江湖', desc: '侠客风范', sample: '南开山庄，癸卯年春。江湖人称"算法侠"的凌云，在这图书馆中苦修已三月有余。今日，他终于在红黑树前迈出了那关键的一步。递归的刀法，一招一式，皆是心血。 BST旋转，如凌波微步，左旋右旋，找准平衡之道。江湖路远，少年的剑，还很长。' },
  { emoji: '📰', name: '新闻联播', desc: '正经搞笑', sample: '据本台记者报道，3月23日，南开大学图书馆发生一起重大"学术事件"。一名软件工程专业学生，在历经三小时的算法题轰炸后，成功将红黑树的核心思想刻入脑海。CNN对此表示高度关注，称其为"人类认知的又一次突破"。专家指出，该名学生今日已摄入足量咖啡因，暂时脱离了学习危险区。' },
  { emoji: '🏯', name: '古风辞赋', desc: '文言古韵', sample: '癸卯年暮春，余于南开学堂，坐于窗畔。晨起读书，午后勤写，暮则漫步于操场。食堂酸菜鱼之味，至今犹在舌尖。是日也，天朗气清，惠风和畅。书卷多情似故人，晨昏忧乐每相亲。此间岁月，静好如此，愿铭之于心，不敢忘却。' },
  { emoji: '🔬', name: '科幻纪元', desc: '未来世界', sample: '星历2026.3.23，基地食堂，能量补充完毕。三食堂的酸菜鱼蛋白棒为今天的训练提供了稳定的碳水供给。下午在图书馆数据节点进行了BST旋转训练，红黑树的平衡因子终于稳定在正常范围内。今天的运动模块也完成了——操场跑步3公里，关节润滑度良好。明日任务预告：继续调参。祝好，基地。' },
  { emoji: '🎬', name: '电影旁白', desc: '镜头语言', sample: '那年春天，他坐在南开图书馆靠窗的位置，阳光斜斜地打在《算法导论》的某一页上。他不知道自己的人生会在这一刻发生什么改变。也许只是多调通了一道二分查找，也许只是记住了红黑树的几个性质。但他知道，从这个春天开始，一切都不一样了。他抬起头，望向窗外的操场——那里有人在跑步，有人在笑，有人在追逐什么。而他，也要开始追逐了。' },
  { emoji: '📖', name: '轻小说', desc: '二次元', sample: '「今天的番茄牛腩，绝对是SSR级别的！」她一边吃一边说，完全忘记了还有算法题没做完的事实。南开大学的食堂，永远是拯救饥饿灵魂的补给站。不过话说回来，红黑树这种东西，真的是策划用来折磨程序员的吧？？？我对着电脑屏幕陷入了沉思，而旁边的室友已经睡着了。算了，明天再说吧。今天的我，也在努力地活着呢。' },
]

const fragments = [
  { time: '12:30', icon: '📸', desc: '二食堂酸菜鱼 (2张)' },
  { time: '14:25', icon: '✍️', desc: '"红黑树太难了"' },
  { time: '16:00', icon: '📸', desc: '图书馆自习 (1张)' },
  { time: '18:00', icon: '📸', desc: '操场跑步 (3张)' },
  { time: '20:30', icon: '🎤', desc: '"今天效率不错"' },
]
...
.preview-style-emoji { font-size: 36rpx; }
